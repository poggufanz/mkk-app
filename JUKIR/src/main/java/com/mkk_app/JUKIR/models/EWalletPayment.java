 ...
 */
public class EWalletPayment implements MetodePembayaran {
    @Override
    public boolean processPayment(double amount, String transactionId) throws PaymentException {
        if (amount <= 0) {
            throw new PaymentException("Jumlah pembayaran E-Wallet harus lebih dari 0");
        }
        System.out.println("Memproses pembayaran E-Wallet sebesar: " + amount + " untuk transaksi: " + transactionId);
        return true;
    }
